...
const LandingPPPPage = () => {
  ...
  // Masquer le footer et header sur cette landing page
  useEffect(() => {
    // Masquer le footer et header
    ...
    // Rétablir le footer et header lors du nettoyage
    return () => {
      const footer = document.querySelector('footer');
      const header = document.querySelector('header');
      if (footer) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        {/* Header personnalisé pour la landing page PPP */}

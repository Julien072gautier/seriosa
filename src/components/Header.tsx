    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link to="/" className="text-gray-800 hover:text-brand font-medium">
            Accueil
          </Link>
          <Link to="/formations" className="text-gray-800 hover:text-brand font-medium">
            Formations
          </Link>
          <Link to="/a-propos" className="text-gray-800 hover:text-brand font-medium">
            À Propos
          </Link>
          <Link to="/contact" className="text-gray-800 hover:text-brand font-medium">
            Contact
          </Link>
          <a 
        ...
        <div className="md:hidden bg-white py-4 px-4 shadow-inner">
          <nav className="flex flex-col space-y-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="btn-primary btn-md btn-with-icon inline-flex"
              onClick={() => setIsMenuOpen(false)}
            >
              <span>SKILLUP</span>
              <ExternalLink size={16} className="ml-2" />

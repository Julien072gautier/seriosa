...
const FormationChinoisPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({
      ...
      subject: "Demande d'information - Formation Chinois",
      text: data
    });
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8">
              Développez des automatismes de communication en chinois et renforcez votre impact professionnel dans un contexte sinophone.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
            <div className="md:flex">
              <div className="md:w-1/2">
                <img 
                  src="https://irp.cdn-website.com/e0ab763a/dms3rep/multi/Chinois.png" 
                  alt="Formation Chinois Professionnel" 
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">LILATE - RS6142</p>
                    </div>
                  </div>
                  <div className="flex items-center">
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-6">Pourquoi apprendre le chinois professionnel ?</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">Marché chinois</h3>
                ...
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Échangez efficacement avec vos partenaires chinois</p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Accueillir une personne en chinois et comprendre ses besoins</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Recueillir des informations et poser des questions en chinois</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Consulter des documents en chinois et comprendre des messages audios</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Prendre des notes efficaces en chinois</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Donner des instructions en chinois</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Comprendre des documents professionnels en chinois</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Participer activement à des réunions en chinois</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Toute personne amenée à communiquer en chinois dans un contexte professionnel</span>
                  </li>
                  <li className="flex items-start">
                    <Users className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                    <span>Professionnels travaillant avec des partenaires chinois</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Cette formation prépare au passage du test LILATE (Live Language Test), certification professionnelle enregistrée au Répertoire Spécifique de France Compétences sous le numéro RS6142.</p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                      <span>Mise en situation sous forme d'échange en chinois</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
              ...
              {!success ? (
                <>
                  ...
                  <p className="text-gray-600 mb-4">
                    Intéressé(e) par notre form'action en chinois professionnel ? Laissez-nous vos coordonnées et un conseiller vous contactera sous 24h.
                  </p>
...
export default FormationChinoisPage;
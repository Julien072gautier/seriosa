...
const FormationArabePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({
      ...
      subject: "Demande d'information - Formation Arabe",
      text: data
    });
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8">
              Développez des automatismes de communication en arabe et renforcez votre impact professionnel dans un contexte arabophone.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
            <div className="md:flex">
              <div className="md:w-1/2">
                <img 
                  src="https://irp.cdn-website.com/e0ab763a/dms3rep/multi/Arabe.png" 
                  alt="Formation Arabe Professionnel" 
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">LILATE - RS6144</p>
                    </div>
                  </div>
                  <div className="flex items-center">
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-6">Pourquoi apprendre l'arabe professionnel ?</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">Marché arabophone</h3>
                      <p className="text-gray-600">Accédez à un marché en pleine expansion et ses opportunités</p>
                    </div>
                  </div>
                  <div className="flex items-start mb-4">
                    <div className="bg-brand-100 p-3 rounded-full mr-4">
                ...
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Échangez efficacement avec vos partenaires arabophones</p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Accueillir une personne en arabe et comprendre ses besoins</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Recueillir des informations et poser des questions en arabe</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Consulter des documents en arabe et comprendre des messages audios</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Prendre des notes efficaces en arabe</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Donner des instructions en arabe</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Comprendre des documents professionnels en arabe</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Participer activement à des réunions en arabe</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Toute personne amenée à communiquer en arabe dans un contexte professionnel</span>
                  </li>
                  <li className="flex items-start">
                    <Users className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                    <span>Professionnels travaillant avec des partenaires arabophones</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Cette formation prépare au passage du test LILATE (Live Language Test), certification professionnelle enregistrée au Répertoire Spécifique de France Compétences sous le numéro RS6144.</p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                      <span>Mise en situation sous forme d'échange en arabe</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
              ...
              {!success ? (
                <>
                  ...
                  <p className="text-gray-600 mb-4">
                    Intéressé(e) par notre form'action en arabe professionnel ? Laissez-nous vos coordonnées et un conseiller vous contactera sous 24h.
                  </p>
...
export default FormationArabePage;
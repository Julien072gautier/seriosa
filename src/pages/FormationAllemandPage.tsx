...
const FormationAllemandPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({
      ...
      subject: "Demande d'information - Formation Allemand",
      text: data
    });
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8">
              Développez des automatismes de communication en allemand et renforcez votre impact professionnel dans un contexte germanophone.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
            <div className="md:flex">
              <div className="md:w-1/2">
                <img 
                  src="https://irp.cdn-website.com/e0ab763a/dms3rep/multi/Allemand.png" 
                  alt="Formation Allemand Professionnel" 
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">LILATE - RS6145</p>
                    </div>
                  </div>
                  <div className="flex items-center">
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-6">Pourquoi apprendre l'allemand professionnel ?</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">Marché germanophone</h3>
                      <p className="text-gray-600">Accédez à la première économie européenne et ses opportunités</p>
                    </div>
                  </div>
                  <div className="flex items-start mb-4">
                    <div className="bg-brand-100 p-3 rounded-full mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Différenciez-vous sur le marché du travail international</p>
                    </div>
                  </div>
                </div>
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Échangez efficacement avec vos partenaires germanophones</p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Accueillir une personne en allemand et comprendre ses besoins</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Recueillir des informations et poser des questions en allemand</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Consulter des documents en allemand et comprendre des messages audios</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Prendre des notes efficaces en allemand</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Donner des instructions en allemand</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Comprendre des documents professionnels en allemand</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Participer activement à des réunions en allemand</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Toute personne amenée à communiquer en allemand dans un contexte professionnel</span>
                  </li>
                  <li className="flex items-start">
                    <Users className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                    <span>Professionnels travaillant avec des partenaires germanophones</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Cette formation prépare au passage du test LILATE (Live Language Test), certification professionnelle enregistrée au Répertoire Spécifique de France Compétences sous le numéro RS6145.</p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                      <span>Mise en situation avec interaction en allemand</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
              ...
              {!success ? (
                <>
                  ...
                  <p className="text-gray-600 mb-4">
                    Intéressé(e) par notre form'action en allemand professionnel ? Laissez-nous vos coordonnées et un conseiller vous contactera sous 24h.
                  </p>

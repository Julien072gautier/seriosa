...
import { Clock, Award, Users, CheckCircle, ArrowRight, Calendar, Phone, X, Tag, CreditCard, MessageSquare, Target, Brain, Star } from 'lucide-react';
...
const FormationCommunityManagementPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({
      ...
      subject: "Demande d'information - Formation Community Management",
      text: data
    });
              ...
              {!success ? (
                <>
                  ...
                  <p className="text-gray-600 mb-4">
                    Intéressé(e) par notre form'action en Community Management ? Laissez-nous vos coordonnées et un conseiller vous contactera sous 24h.
                  </p>

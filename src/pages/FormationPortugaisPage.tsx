...
import { Clock, Award, Users, CheckCircle, ArrowRight, Calendar, Phone, X, Tag, CreditCard, MessageSquare, Target, Brain, Star, Globe } from 'lucide-react';
import { useSendEmail } from '../hooks/useSendEmail';
import { Link } from 'react-router-dom';

const FormationPortugaisPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({
      ...
      subject: "Demande d'information - Formation Portugais",
      text: data
    });
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8">
              Développez des automatismes de communication en portugais et renforcez votre impact professionnel dans un contexte lusophone.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
            <div className="md:flex">
              <div className="md:w-1/2">
                <img 
                  src="https://irp.cdn-website.com/e0ab763a/dms3rep/multi/Portugais.png" 
                  alt="Formation Portugais Professionnel" 
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">LILATE - RS6143</p>
                    </div>
                  </div>
                  <div className="flex items-center">
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-6">Pourquoi apprendre le portugais professionnel ?</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">Marché lusophone</h3>
                      <p className="text-gray-600">Accédez à un marché de plus de 280 millions de locuteurs</p>
                    </div>
                  </div>
                  <div className="flex items-start mb-4">
                    <div className="bg-brand-100 p-3 rounded-full mr-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">Compétitivité accrue</h3>
                      <p className="text-gray-600">Différenciez-vous sur le marché international</p>
                    </div>
                  </div>
                </div>
                <div>
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Échangez efficacement avec vos partenaires lusophones</p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Accueillir une personne en portugais et comprendre ses besoins</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Recueillir des informations et poser des questions en portugais</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Transmettre des consignes et des instructions dans un cadre professionnel</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                  <span>Consulter des documents en portugais et comprendre des messages audios</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Prendre des notes efficaces en portugais</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Donner des instructions en portugais</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Comprendre des documents professionnels en portugais</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
                    <span>Participer activement à des réunions en portugais</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="text-brand mr-3 mt-1 flex-shrink-0" size={16} />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Toute personne amenée à communiquer en portugais dans un contexte professionnel</span>
                  </li>
                  <li className="flex items-start">
                    <Users className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                    <span>Professionnels travaillant avec des partenaires lusophones</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                    <span>Niveau A1 introductif ou A2 intermédiaire</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Cette formation prépare au passage du test LILATE (Live Language Test), certification professionnelle enregistrée au Répertoire Spécifique de France Compétences sous le numéro RS6143.</p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                      <span>Mise en situation sous forme d'échange en portugais</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
                      <span>Retranscription d'un message écrit et réponses aux questions</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="text-brand mr-3 mt-1 flex-shrink-0" size={20} />
              ...
              {!success ? (
                <>
                  ...
                  <p className="text-gray-600 mb-4">
                    Intéressé(e) par notre form'action en portugais professionnel ? Laissez-nous vos coordonnées et un conseiller vous contactera sous 24h.
                  </p>
...
export default FormationPortugaisPage;